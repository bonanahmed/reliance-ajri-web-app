...
<main class="content">
    ...
    <div class="container-fluid p-0">
        ...
        <h1 class="h3 mb-3"><strong>Slider Content</strong> Dashboard</h1>
        <div class="row">
            ...
            <div class="col-12 d-flex">
                <div class="card flex-fill">
                    <div class="card-header">
                        <a href="/c/slider/create" class="btn btn-primary m-2">Add Content</a>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="d-none d-md-table-cell">
                                    <a href="/c/slider/{{$item->id}}/edit" class="badge bg-success">
                                        <span data-feather="edit-2"></span>
                                    </a>
                                    <form action="/c/slider/{{$item->id}}" class="d-inline" method="post">
                                        @method('delete')
                                        @csrf
