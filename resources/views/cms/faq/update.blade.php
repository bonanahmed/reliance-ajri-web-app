...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <h1 class="h3 mb-3">FAQ Editor</h1>

        <div class="col-lg-8">
            <form action="/c/faq" method="post" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                    <label for="value" class="form-label">Title</label>
                    <input name="value" value="{{ old('value',$variabel->faq->value ?? '')}}" type="text" class="form-control @error('value') is-invalid @enderror" id="value" aria-describedby="value">
                    @error('value')
                ...
                <div class="mb-3">
                    ...
                    <img src="{{ asset('storage/'.$variabel->faq->image) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                    @endif
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="editor" name="content">{!! $variabel->faq->content ?? '' !!}</textarea>
                    <!-- <input id="content" type="hidden" name="content" value="{{ old('content',$variabel->faq->content ?? '') }}"> -->
                    @error('content')
                    <p class="text-danger">
                        {{ $message }}
                    </p>
