        ...
        <div class="col-lg-8">
            <form action="/c/brosur/{{ $brosur->slug }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input @if(!$brosur->image) required @endif name="image" id="image" class="form-control @error('image') is-invalid @enderror" type="file" onchange="previewImage()">
                    @error('image')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <input name="file" type="file" class="form-control @error('file') is-invalid @enderror" id="file" aria-describedby="file">
                    @error('file')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
