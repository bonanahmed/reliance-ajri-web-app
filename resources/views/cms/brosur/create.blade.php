...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <h1 class="h3 mb-3">Create Brosur</h1>

        <div class="col-lg-8">
            <form action="/c/brosur" method="post" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input required name="image" id="image" class="form-control @error('image') is-invalid @enderror" type="file" onchange="previewImage()">
                    @error('image')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <input required name="file" type="file" class="form-control @error('file') is-invalid @enderror" id="file" aria-describedby="file" multiple="false">
                    @error('file')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
...
<script>
    ...
    title.addEventListener('change', function() {
        fetch('/c/brosur/checkSlug?title=' + title.value).then(resp => resp.json()).then(data => slug.value = data.slug)
    })
