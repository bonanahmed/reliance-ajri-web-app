...
<main class="content">
    ...
    <div class="container-fluid p-0">
        ...
        <h1 class="h3 mb-3"><strong>Brosur Kategori</strong> Dashboard</h1>
        <div class="row">
            ...
            <div class="col-12 d-flex">
                <div class="card flex-fill">
                    <div class="card-header">
                        <a href="/c/category_brosur/create" class="btn btn-primary m-2">Create kategori</a>
                    </div>
...
<script>
    $(document).ready(function() {
        var table = $('#myTable').DataTable({
            ...
            responsive: true,
            "autoWidth": false,
            ajax: "{!! route('category_brosur.index') !!}",
            order: [
                [1, 'asc']
            ],
            columns: [{
