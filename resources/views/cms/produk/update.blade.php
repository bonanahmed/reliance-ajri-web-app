        ...
        <div class="col-lg-8">
            <form action="/c/produk/{{ $produk->slug }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input @if(!$produk->image) required @endif name="image" id="image" class="form-control @error('image') is-invalid @enderror" type="file" onchange="previewImage()">
                    @error('image')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="mb-3">
                    <label for="title" class="form-label">Body</label>
                    <textarea class="form-control" id="editor" name="body">{!! $produk->body !!}</textarea>
                    @error('body')
                    <p class="text-danger">
                        {{ $message }}
                    </p>
