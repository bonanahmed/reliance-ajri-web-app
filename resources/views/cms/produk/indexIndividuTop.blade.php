        ...
        <div class="col-lg-8">
            <form action="/c/produk/individu/top" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="editor" name="content">{!! $variabel->produk_individu_sec1->content ?? '' !!}</textarea>
                    @error('content')
                    <p class="text-danger">
                        {{ $message }}
                    </p>
                ...
                <div class="mb-3">
                    ...
                    <input type="hidden" name="oldImage" value="{{$variabel->produk_individu_sec1->image}}">
