        ...
        <div class="col-lg-8">
            <form action="/c/produk/individu/diagram" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input @if(!$variabel->produk_diagram->image) required @endif name="image" id="image" class="form-control @error('image') is-invalid @enderror" type="file" onchange="previewImage()">
                    @error('image')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
