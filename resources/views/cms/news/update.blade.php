        ...
        <div class="col-lg-8">
            <form action="/c/news/{{ $news->slug }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input value="{{ old('meta_title',$news->meta_title)}}" name="meta_title" type="text" class="form-control @error('meta_title') is-invalid @enderror" id="meta_title" aria-describedby="meta_title">
                    @error('meta_title')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <input value="{{ old('meta_description',$news->meta_description)}}" name="meta_description" type="text" class="form-control @error('meta_description') is-invalid @enderror" id="meta_description" aria-describedby="meta_description">
