    ...
    <div class="row py-5">
        ...
        <div class="col-md-12 your-class my-2 mb-5">
            ...
            <div class="mx-2 justify-content-center text-center">
                @if($mitra->image)
                <img style="height: 136px; padding:30px; object-fit: contain; border:none; background:#F2F2F2;" class="img-thumbnail"
                    src="{{ asset('storage/'.$mitra->image) }}" alt="">
                @else
                <img style="height: 136px; padding:30px; object-fit: contain ; border:none; background:#F2F2F2;" class="img-thumbnail"
                    src="https://via.placeholder.com/160x56" alt="">
                @endif
            </div>
            @endforeach
        </div>
                        ...
                        <div class="row justify-content-end">
                            <div class="card card-right">
                                <div class="card-body">
                                    ...
                                    <a href="{{ $item->button_link ?? '#' }}" class="btn btn-primary btn-sm "
                                        style="background-color: #29559B; display: flex; flex-direction: row; align-items: center; padding: 16px 32px; gap: 16px;width: 220px;height: 64px;border-radius: 12px;">
                                        {{ $item->button }}
                                    </a>
                                </div>
                            </div>
...
<section class="mb-10"
    style="background-image: url('{{ asset('assets/img/family-portrait.png') }}');background-size: cover;background-repeat: no-repeat;  background-attachment: fixed;  background-position: center;">
    <div class="container">
        <div class="row" style="padding:25px 60px 0px ;">
            <div class="col-md-6" style="padding-bottom: 300px;">
                ...
                <button type="button" class="btn btn-primary btn-sm py-3 px-4"
                    style="border-radius: 10px;border:none; background-color: #29559B;">
                    Lihat Selengkapnya
                </button>
            </div>
        </div>
...
<section id="produk" class="mt-5">
    <div class="container py-5">
        <div class="row">
            <div class="col text-center">
                <p style="font-size: 32px;font-weight: 500;"><span style="color: #737373;">Pilihan</span> <span
                        style="color: #29559B;">Produk Terbaik</span> <span style="color: #737373;">Kami</span></p>
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-5">
                <div class="card border-0">
                    ...
                    @else
                    <img src="{{ asset('assets/img/info-daily.png') }}" class="card-img-top"
                        style="border-radius: 10px;" alt="{{ $item->title }}">
                    @endif
