                ...
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0 navbar-custom">
                    ...
                    <li class="nav-item dropdown mx-3">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdown_about_us">
                            ...
                            @endforeach
                            <li><a class="dropdown-item" href="/keuangan">Laporan Keuangan</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown mx-3">
                    ...
                    <li class="nav-item dropdown mx-3">
                        <a class="nav-link {{ Request::is('klaim/*') ? 'active' : '' }} dropdown-toggle" id="navbarKlaimScrollingDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" href="#">Klaim</a>
